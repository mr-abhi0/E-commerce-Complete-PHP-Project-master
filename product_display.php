...
<?php include('includes/menu.php');?>
  ...
  <?php include('db_cons.php');
	if(isset($_GET['s_id']))
			{
			$sub_cat=$_GET['s_id'];
$select="select *from project_live WHERE sub_cat=".$sub_cat.";";
...
$news_type=$row['news_type'];
	?>
                <!-- start single product item -->
                  <li>
                      <figure>
                        <a class="aa-product-img" href="pages.php?id=<?php echo $id_live;?>"><img src="proimage/<?php echo $image;?>" width="250" height="300"></a>
