...
<html lang="en">
 ...
 <?php 
include('db_con1.php'); 
$query_parent =mysqli_query($con,"SELECT * FROM category") or die("Query failed: ".mysqli_error());
?>
				...
				<div class="main-content-inner">
					...
					<?php include('includes/setting.php');?>
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
		<form action="ad_post.php" method="post" enctype="multipart/form-data" media="all">

                
				<table>
				<tr>
				<td>Post Title</td>
				<td><input type="text" name="project_title1" size="100%">
				...
				<tr>
				<td>Keyworld</td>
				<td><input type="text" name="keyworld" size="100%">
				</td>
				</tr>
					...
					<tr>
				<td>IP Address</td>
				<td><input type="text" name="ipaddress" size="100%" value="<?php
...
<tr>
				<td>Product Code</td>
				<td><input type="text" name="code" value="Aka<?php

echo(rand(10,100));?>" size="100%" readonly>
				</td>
				</tr>

<tr>
				<td>Seling Price</td>
				<td><input type="text" name="price" size="100%">
				</td>
				</tr>
				...
				<tr>
				<td>MRP.</td>
				<td><input type="text" name="descount" size="100%" placeholder="200,10,500">
				</td>
				</tr>
				
				<tr>
				<td>Shipping Charge</td>
				<td><input type="text" name="shippingCharge" size="100%" placeholder="200,10,500">
				</td>
				</tr>
	...
	<option>Select a Categories</option>  
        ...
        <?php endwhile; ?>
				...
				<td>
				 <select name="sub_cats" id="sub_cat" class="form-control">
<option>Select a sab Categories</option>
				...
				<td>	 <select name="news"  class="form-control">
				<option>Select In Type</option>
				<option value="In Stock">In Stock</option>
				<option value="UpComming In Stock">UpComming In Stock</option>
					<option  value="Sold Out">Sold Out</option>
				</select></td>
				</tr>
				
					<tr>
				<td>Full Describtion</td>
