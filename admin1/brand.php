				...
				<div class="main-content-inner">
					...
					<?php include('includes/setting.php');?>
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form action="add_brand.php" class="form-horizontal"   method="post">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Add Brand </label>

										<div class="col-sm-9">
											
											<input type="hidden"  name="employeeid" value="<?php echo $show['employee_id']; ?>"  placeholder="mobile" class="col-xs-10 col-sm-5" />
											<input type="text"  name="brand_id"  placeholder="hp" class="col-xs-10 col-sm-5" />
								...
								<table id="simple-table" class="table  table-bordered table-hover">
											...
											<?php
include('db_con1.php');
$select_query="select *from brand ORDER BY brand_id ASC";
