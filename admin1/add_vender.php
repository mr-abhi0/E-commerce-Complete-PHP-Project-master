...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>City printing enterprise</title>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Vender Name</li>
						</ul><!-- /.breadcrumb -->
					...
					<?php include('includes/setting.php');?>
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form action="add_vender_name.php" class="form-horizontal"   method="post">
								...
								<table id="simple-table" class="table  table-bordered table-hover">
											...
											<?php
include('db_con1.php');
$select_query="select *from vender_name ORDER BY cat_id ASC";
												...
												<tr>
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">
																	...
																	<a href="delete_vender.php?del=<?php echo $cat_id; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
																			<span class="red">
