...
<form method="post" action="update_product.php?edit_form=<?php echo $id_live; ?>" enctype="multipart/form-data">
				...
				<tr>
				<td>Post Title</td>
				<td><input type="text" name="project_title1" value="<?php  echo $Project_title;?>" size="100%">
				...
				<tr>
				<td>Short Title</td>
				<td><input type="text" name="short_des" value="<?php echo $short_des; ?>" size="100%">
				</td>
				</tr>
				...
				<tr>
				<td>Keyworld</td>
				<td><input type="text" name="keyworld" value="<?php echo $keyworld;?>" size="100%">
				</td>
				</tr>
...
<tr>
				<td>Seling Price</td>
				<td><input type="text" name="price" value="<?php echo $edit_row['price'];?>" size="100%">
				</td>
				</tr>
				...
				<tr>
				<td>Descount MRP.</td>
				<td><input type="text" name="descount" value="<?php echo $descount;?>" size="100%">
				</td>
				</tr>
				
				
				<tr>
				<td>Product Avelability</td>
			 ...
			 <td>
	<textarea  id="editor"  col="2" rows="5" name="Project_discription"><?php echo $Project_discription?></textarea></td>
				</tr>
