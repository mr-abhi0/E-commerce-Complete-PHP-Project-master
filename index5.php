			...
			<li>
				<div class="cart-item product-summary">
					<div class="row">
						<div class="col-xs-4">
							<div class="image">
								<a href="detail.html"><img  src="admin/productimages/<?php echo $row['id_live'];?>/<?php echo $row['image'];?>" width="35" height="50" alt=""></a>
							</div>
						</div>
						<div class="col-xs-7">
							
							<h3 class="name"><a href="index5.php?page-detail"><?php echo $row['Project_title']; ?></a></h3>
							<div class="price">Rs.<?php echo($row['price']);?><?php echo $_SESSION['cart'][$row['id_live']]['quantity']; ?></div>
						</div>
...
while($row=mysqli_fetch_array($sql))
{
    ?>
			...
			<li class="dropdown yamm">
				<a href="category.php?cid=<?php echo $row['cat_id'];?>"> <?php echo $row['category_name'];?></a>
	...
	?>
                        <li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn"href="index5.php?page=product&action=add&id=<?php echo $row['id_live']; ?>"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                              <figcaption>
