...
$news_type=$row['news_type'];
	...
	?>
					         ...
					         <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="proimage/<?php echo $image;?>" width="250" height="300" alt="<?php echo $Project_title;?>"></a>
	...
	?>	
                                  ...
                                  <div class="simpleLens-container">
                                      <div class="simpleLens-big-image-container">
                                          <a class="simpleLens-lens-image" data-lens-image="proimage/<?php echo $image;?>">
                                             <img src="proimage/<?php echo $image;?>" width="250" height="300" class="simpleLens-big-image">
                                          </a>
                                      </div>
                                  </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="aa-price-block">
                                  ...
                                  <p class="aa-product-avilability">Avilability: <span><?php echo $news_type; ?></span></p>
                                </div>
                                <p><?php echo substr($row['short_des'],0,200);?></p>
                                <h4>Size</h4>
