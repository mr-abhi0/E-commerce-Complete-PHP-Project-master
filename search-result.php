...
<?php include('includes/menu.php');?>
  ...
  <section id="aa-catg-head-banner">
   <img src="img/12.webp" alt="" style="height:300px;width:100%;">
...
$ret=mysqli_query($con,"select *from project_live where Project_title like '$search_id%'");
...
{?>	
                <!-- start single product item -->
                  <li>
                      <figure>
                        <a class="aa-product-img" href="#"><img src="proimage/<?php echo $row['image'];?>" width="250" height="300"></a>
                        <a class="aa-add-card-btn"href="index.php?page=product&action=add&id=<?php echo $row['id_live']; ?>"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                         <figcaption>
                          <h4 class="aa-product-title"><a href="pages.php?id=<?php echo $row['id_live'];?>"><?php echo substr($row['Project_title'],0,20);?></a></h4>
                          <span class="aa-product-price">Rs.<?php echo $row['price']; ?></span><span class="aa-product-price"><del>Rs.<?php echo $row['descount']; ?></del></span>
                        </figcaption>
                      </figure>                     
                      <div class="aa-product-hvr-content">
                        <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span class="fa fa-heart-o"></span></a>
                        <a href="#" data-toggle="tooltip" data-placement="top" title="Compare"><span class="fa fa-exchange"></span></a>
                        <a href="pages.php?id=<?php echo $row['id_live'];?>" data-toggle2="tooltip" data-placement="top"> <span class="fa fa-search"></span></a>                            
                      </div>
                      <!-- product badge -->
                      <span class="aa-badge aa-sale" href="#"><?php echo $row['news_type']; ?></span>
                    </li>
        <?php } }} else {?>
